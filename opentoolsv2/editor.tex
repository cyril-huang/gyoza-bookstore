...
C-x C-t		:轉換兩行
    ...
    ctrl-v 一個是原本 X 提供的， 只要用滑鼠左鍵標好，可以按 shift 鍵調整，然
...
\end{verbatim}
  ...
  \end{itemize}
    ...
    \\\\
    Linux下就去下載 JRE 與 \href{https://eclipse.org}{eclipse.org}，以前自己下
    載 luna 版本IDE for Java Developers 的。與 oracle的jre 1.7。現在最新版的
    只要解開 tar.gz 檔，跑裡面的 ./eclipse-inst 就自動幫你下載其他需要的東西
    ，非常好安裝。
    \begin{itemize}
    ...
    有一些\href{http://vim.wikia.com/wiki/Use\_Vim\_like\_an\_IDE}{介紹}
      ...
      \begin{itemize}
        ...
        \item 安裝 lazyvim plugin 'git clone https://github.com/LazyVim/starter \$HOME/.config/nvim'
        \item 要花俏的外觀要裝
          \begin{itemize}
